    ...
    public class Signal : INotifyPropertyChanged
    {
        ...
        public void SetValue(byte[] register)
        {
            ...
            if (Value.GetType() == typeof(string))
            {
                ...
                //Lire la longueur LEN (2 premiers octets, little-endian)
                ushort len = BitConverter.ToUInt16(register, (int)ByteAdress);

                //Extraire les caractères ASCII
                var v = Encoding.ASCII.GetString(register, (int)ByteAdress+4, len);
        ...
        public void SetRegister(byte[] register)
        {
            ...
            ////Set byte array with string type
            //if (Value.GetType() == typeof(string))
            //{
